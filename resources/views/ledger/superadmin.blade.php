    ...
    <aside class="sidebar">
      ...
      <nav class="nav">
        <div class="nav-group-label">Menu</div><a href="{{ route('admin') }}">Input Transaksi</a><a
          href="{{ route('superadmin') }}" class="active">Dashboard Super Admin</a>
      </nav>
      <div class="sidebar-foot">
        <form method="POST" action="{{ route('logout', 'superadmin') }}">@csrf<button class="btn btn-ghost btn-sm"
      ...
      <div class="stat-grid">
        ...
        <div class="stat-card red">
          ...
          <div class="stat-value">Rp
            {{ number_format($transactions->count() ? $totalNominal / $transactions->count() : 0, 0, ',', '.') }}</div>
          ...
          <table>
            ...
            <tbody>@forelse($months as $month)
              <tr>
                ...
                <td class="mono">Rp
                  {{ number_format($month->count ? $month->total_nominal / $month->count : 0, 0, ',', '.') }}</td>
            </tr>@empty<tr>
