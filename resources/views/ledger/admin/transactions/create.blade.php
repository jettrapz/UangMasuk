  ...
  <div class="app-shell">
    ...
    <main class="main">
      ...
      <div class="card">
        ...
        @if($editing)<div class="edit-banner">Mengedit transaksi: {{ $editing->nama }} <a class="btn btn-ghost btn-sm" href="{{ route('admin.transactions.create') }}">Batal Edit</a></div>@endif
        <form method="POST" action="{{ $editing ? route('admin.transactions.update', $editing) : route('admin.transactions.store') }}" enctype="multipart/form-data">
          @csrf
